...
print(f"Suma de numero entero y decimal: {suma}")
...
print(f"Resta de numero entero y decimal: {resta}")
print(f"Multiplicacion de numero entero y decimal: {multiplicacion}")
print(f"Division de numero entero y decimal: {division}")
...
#7. Ahora, sin borrar la variable anterior, crea una variable llamada "descuento" y asígnaleun valor decimal que represente el descuento aplicado al artículo. Por ejemplo, si le quieres aplicar un 25% de descuento, dale un valor de 0,25. El valor 1 equivaldría al 100% y el valor 0 al 0%.
descuento = 0.5
...
cadena = "Una frase para una variable"
...
longitud = len(cadena)
print(f"Longitud de la cadena: {cadena}")
...
precio = int(precio)
print(f"Precio pero en entero: {precio}")
...
edad += 5
print(f"Edad sumada: {edad}")

edad -= 10
print(f"Edad restada: {edad}")
...
altura *= 4
print(f"Altura multiplicada: {altura}")

altura /= 3
print(f"Altura dividida: {altura}")
...
print(f"Nombre en mayusculas: {nombre}")
print(f"Nombre en minusculas: {nombre_minusculas}")
...
print(f"Nombre con primera letra en mayuscula: {nombre_titulo}")
